...
const Gateway = () => {
  return (
    <section className="flex h-screen w-screen items-center justify-center bg-[#fbf5f0]">
      <div className='absolute inset-0 mt-[100px] aspect-video h-full w-full bg-no-repeat blur-sm sm:bg-[url("../money-protector/images/gateway/gate_main_sm.jpg")] sm:bg-cover md:bg-[url("../money-protector/images/gateway/gate_main_md.jpg")] md:bg-cover  lg:bg-[url("../money-protector/images/gateway/gate_main_lg.jpg")] lg:bg-cover lg:bg-right' />
      <main className="relative flex h-full w-full flex-col items-center">
        <div className="absolute left-1/2 top-1/2 flex w-full -translate-x-1/2 -translate-y-1/2 flex-col items-center rounded-lg bg-opacity-50 shadow-2xl ">
