...
const SHAPE = {
  kakao:
    "h-16 w-16 rounded-full bg-[url('../money-protector/images/kakao_button.png')] bg-center bg-no-repeat",
  ...
  nav: "h-8 w-8 rotate-2 bg-[url('../money-protector/images/nav_button.png')] bg-center bg-no-repeat transition-all duration-500 hover:bg-[url('../money-protector/images/nav_close_button.png')] hover:bg-center hover:bg-no-repeat",
  back: "h-8 w-8 bg-[url('../money-protector/images/back_button.png')] bg-center bg-no-repeat",
  reading:
